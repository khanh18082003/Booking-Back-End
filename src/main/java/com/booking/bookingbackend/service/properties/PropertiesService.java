...
public interface PropertiesService
        extends BaseEntityService<UUID, Properties, PropertiesRepository, PropertiesResponse> {
    ...
    PaginationResponse<PropertiesDTO> searchProperties(
            PropertiesSearchRequest request, int pageNo, int pageSize, String[] filters, String... sort);
    ...
    String addLovedPropertiesInRedis(PropertiesDTO request);

    PropertiesDTO getLovedPropertiesInRedis(String id);
}
