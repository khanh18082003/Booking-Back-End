...
public record UserCreationRequest(
        ...
        @NotBlank(message = "MESSAGE_NOT_BLANK") @Size(min = 8, max = 20, message = "MESSAGE_INVALID_SIZE")
                String password,
        @NotBlank(message = "MESSAGE_NOT_BLANK") @JsonProperty("confirm_password") String confirmPassword,
