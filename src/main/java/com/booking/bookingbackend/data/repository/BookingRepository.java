...
public interface BookingRepository extends BaseRepository<Booking, UUID> {
	...
	""",
		...
		""",
            nativeQuery = true)
    Page<UserBookingsHistoryDTO> findUserBookingsHistory(@Param("user_id") UUID userId, Pageable pageable);
    ...
    @Query(
		...
		""",
			...
			""",
            nativeQuery = true)
    Page<Tuple> findAllByPropertiesId(UUID propertiesId, Pageable pageable);
    ...
    @Query(
		...
		""",
			...
			""",
            nativeQuery = true)
    Page<Tuple> findAllOfHost(UUID hostId, Pageable pageable);
}
