...
public interface UserRepository extends BaseRepository<User, UUID> {
    ...
    RevenueResponse revenueByHostIdWithMonthAndYear(
            @Param("hostId") UUID userId, @Param("month") int month, @Param("year") int year);
	...
	""",
            nativeQuery = true)
    List<RevenueResponse> revenueByHostIdWithYear(@Param("hostId") UUID userId, @Param("year") int year);
}
